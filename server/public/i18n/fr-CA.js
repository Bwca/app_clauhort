...
export default {
  ...
  'category.assignTitle': 'Définir la catégorie',
  'category.assignPlaceholder': 'Catégorie…',
  'category.renameTitle': 'Renommer la catégorie',
  'category.deleteTitle': 'Supprimer la catégorie',
  'category.uncategorizedLabel': 'Sans catégorie',
  ...
  'agentModal.modelLabel': 'Modèle',
  'agentModal.modelHint': '(optionnel — laisser vide pour laisser Claude Code choisir)',
  'agentModal.modelPlaceholder': 'p. ex. opus, sonnet, ou un ID de modèle complet',
  ...
  'confirm.renameBtn': 'Renommer',
  'confirm.renameCategory': 'Renommer la catégorie « {name} » en :',
  'confirm.deleteCategory_one': 'Retirer la catégorie « {name} » de son {count} discussion? Elle deviendra sans catégorie.',
  'confirm.deleteCategory_other': 'Retirer la catégorie « {name} » de ses {count} discussions? Elles deviendront sans catégorie.',
  'confirm.switchModel': 'Changer le modèle utilisé par {name}? Entrez un alias (opus, sonnet, haiku, fable) ou un ID de modèle complet — laissez vide pour laisser Claude Code choisir automatiquement. Prend effet au prochain message; l\'historique de conversation est conservé.',
  'confirm.switchModelPlaceholder': 'p. ex. opus, sonnet, ou un ID de modèle complet',
  'confirm.switchModelBtn': 'Changer',
  ...
  'quickMsg.addBtn': 'Ajouter un message rapide',
  'quickMsg.addPrompt': 'Texte du nouveau message rapide :',
  'quickMsg.editPrompt': 'Modifier le texte du message rapide :',
  'quickMsg.textPlaceholder': 'p. ex. Veuillez continuer',
  'quickMsg.editTitle': 'Modifier ce message rapide',
  'quickMsg.deleteTitle': 'Supprimer ce message rapide',
  'quickMsg.saveBtn': 'Enregistrer',
  ...
  'errors.categoryFromRequired': 'from est requis',
  ...
  'errors.quickMessageTextRequired': 'le texte est requis',
  'errors.quickMessageNotFound': 'Message rapide introuvable',
