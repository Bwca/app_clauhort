...
export default {
  ...
  'category.assignTitle': 'Set category',
  'category.assignPlaceholder': 'Category…',
  'category.renameTitle': 'Rename category',
  'category.deleteTitle': 'Delete category',
  'category.uncategorizedLabel': 'Uncategorized',
  ...
  'agentModal.modelLabel': 'Model',
  'agentModal.modelHint': '(optional — leave blank to let Claude Code choose)',
  'agentModal.modelPlaceholder': 'e.g. opus, sonnet, or a full model ID',
  ...
  'confirm.renameBtn': 'Rename',
  'confirm.renameCategory': 'Rename category "{name}" to:',
  'confirm.deleteCategory_one': 'Remove category "{name}" from its {count} chat? The chat becomes Uncategorized.',
  'confirm.deleteCategory_other': 'Remove category "{name}" from its {count} chats? They become Uncategorized.',
  'confirm.switchModel': 'Switch the model {name} runs on? Enter an alias (opus, sonnet, haiku, fable) or a full model ID — leave blank to let Claude Code choose automatically. Takes effect on the next message; conversation history is kept.',
  'confirm.switchModelPlaceholder': 'e.g. opus, sonnet, or a full model ID',
  'confirm.switchModelBtn': 'Switch',
  ...
  'quickMsg.addBtn': 'Add quick message',
  'quickMsg.addPrompt': 'New quick message text:',
  'quickMsg.editPrompt': 'Edit quick message text:',
  'quickMsg.textPlaceholder': 'e.g. Please continue',
  'quickMsg.editTitle': 'Edit this quick message',
  'quickMsg.deleteTitle': 'Delete this quick message',
  'quickMsg.saveBtn': 'Save',
  ...
  'errors.categoryFromRequired': 'from is required',
  ...
  'errors.quickMessageTextRequired': 'text is required',
  'errors.quickMessageNotFound': 'Quick message not found',
